...
The Kickstart ROM for the Amiga 3000 should be burned to 100ns or faster 27C4096 EPROMs (DIP-40 footprint) for use by the AmigaPCI. Original Amiga Kickstart Mask ROMs or EPROMs are not supported. 
...
The AmigaPCI maintains a number of user ports to enable the use of legacy Amiga devices.
