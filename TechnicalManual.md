...
Parity is generated by the PCI Bridge on all MC68040 driven cycles and verified on all target device responses to MC68040 accesses. Parity is used to verify the data integrity of data transactions by considering AD[31..0] and _C/BE[3..0] signals. The PAR signal is driven one clock after the corresponding address or data block. 
